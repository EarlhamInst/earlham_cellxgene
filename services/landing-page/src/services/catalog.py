...
class DatasetCatalog:
    ...
    def filter_by_organism(self, organism: str) -> List[Dataset]:
        ...
        return [ds for ds in self.datasets if ds.organism.lower() == organism_lower]
    ...
    def filter_by_tissue(self, tissue: str) -> List[Dataset]:
        ...
        return [ds for ds in self.datasets if ds.tissue.lower() == tissue_lower]
    ...
    def filter_by_assay(self, assay: str) -> List[Dataset]:
        ...
        return [ds for ds in self.datasets if ds.assay.lower() == assay_lower]
    ...
    def sort_by_name(self, reverse: bool = False) -> List[Dataset]:
        ...
        """
        return sorted(
            self.datasets, key=lambda ds: ds.display_name.lower(), reverse=reverse
        )
    ...
    def sort_by_cell_count(self, reverse: bool = True) -> List[Dataset]:
        ...
        sorted_with_count = sorted(
            with_count, key=lambda ds: ds.cell_count, reverse=reverse
        )
    ...
    def sort_by_file_size(self, reverse: bool = True) -> List[Dataset]:
        ...
        """
        return sorted(
            self.datasets, key=lambda ds: ds.file_size_bytes or 0, reverse=reverse
        )
